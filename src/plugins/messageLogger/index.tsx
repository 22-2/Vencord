...
import { ChannelStore, FluxDispatcher, Menu, MessageCache, MessageStore, moment, Parser, SelectedChannelStore, Timestamp, UserStore, useStateFromStores } from "@webpack/common";
...
import { makeEdit, normalizePersistedMessage, parseEditContent, reAddDeletedMessages } from "./utils";
    ...
    patches: [
...

        {
            ...
            replacement: [
                {
                    match: /\.SPOILER,(?=\[\i\.\i\]:)/,
                    replace: '.SPOILER,"messagelogger-deleted-attachment":arguments[0]?.item?.originalItem?.deleted,'
                }
            ]
        },
