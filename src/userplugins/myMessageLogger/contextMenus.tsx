 ...
 */
export const patchMessageContextMenu: NavContextMenuPatchCallback = (
    children,
    props,
) => {
    const { message } = props;
 ...
 */
export const patchChannelContextMenu: NavContextMenuPatchCallback = (
    children,
    { channel },
) => {
    const messages = MessageStore.getMessages(channel?.id) as MyMLMessage[];
 ...
 */
export const patchGuildContextMenu: NavContextMenuPatchCallback = (
    children,
    { guild },
) => {
    if (!guild) return;
 ...
 */
export const patchChannelMonitoringContextMenu: NavContextMenuPatchCallback = (
    children,
    { channel },
) => {
    if (!channel) return;
    ...
    children.push(
        <Menu.MenuItem id={MENU_IDS.MONITOR_CHANNEL} label="Message Logger">
            <Menu.MenuItem
